...
import './App.css';
import {AutoList, Modal} from "./components/comps";
...
function App() {
  ...
  // Aplicar la clase cuando cambia el estado
  useEffect(() => {
    if (isLightMode) {
      ...
      <div className="app-container">
        ...
        <div className="app-content">
          <div className="app-content-header">
            ...
            <button className="app-content-headerButton" onClick={() => setIsModalOpen(true)}>Add Product</button>
